...
int main(void)
{
  ...
  HAL_ADC_Start_DMA(&hadc2, adc2_values, 4);
  HAL_ADC_Start_DMA(&hadc3, adc3_values, 2);
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  printf("ADC1: %lu %lu %lu %lu\n", adc1_values[0], adc1_values[1], adc1_values[2], adc1_values[3]);
	  printf("ADC2: %lu %lu %lu %lu\n", adc2_values[0], adc2_values[1], adc2_values[2], adc2_values[3]);
